...
Changelogs:AddParagraph("v4.4 Reborn", "What's new? Fixed ultimate badge hub doesn't load on other places. Added auto-get eggler and support to eggler dimension.")
...
Launcher:AddDropdown({
	Name = "Choose Version",
	Default = "v4.4 - Reborn",
	Options = {"v4.4 - Reborn", "v4.3 - Reborn", "v4.2 - Reborn", "v4.1 - Reborn", "v4.0", "v3.9", "v3.8", "v3.7", "v3.6", "v3.5", "v3.4", "v3.3", "v3.2", "v3.1", "v3.0"},
	Callback = function(Value)
-- using _G.Version = Value ?? LOL nah I'd like use something like this
if Value == "v4.4 - Reborn" then
_G.Version = "v4.4 - Reborn"
elseif Value == "v4.3 - Reborn" then
...
Launcher:AddButton({
	...
	Callback = function()
if _G.Version == "v4.4 - Reborn" then
DestroyLauncher()
...
elseif _G.Version == "v4.3 - Reborn" then
DestroyLauncher()
